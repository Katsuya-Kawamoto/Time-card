...
<?php foreach($info as $key => $value) :?>
                                    <tr>
                                        ...
                                        <td class="delete"><input type="radio" name="check[]" value="<?php echo h($value["number"]);?>"></td>
                                    </tr>
<?php endforeach; ?>
                                </tbody>
                            </table>
...
<?php for($i=$time["year"]-1;$i<=$time["year"]+1;$i++):?>
                            <option value="<?php echo (int)h($i);?>" <?php if((int)$time["year"]===(int)h($i)) echo "selected";?>><?php echo (int)h($i);?>年</option>
<?php endfor; ?>
                        </select>
                        <select name="month" id="month">
<?php for($i=1;$i<=12;$i++):?>
                            <option value="<?php echo (int)h($i);?>" <?php if((int)$time["month"]===(int)h($i)) echo "selected";?>><?php echo (int)h($i);?>月</option>
<?php endfor; ?>
                        </select>
<?php if(isset($output["error"])):?>
                        <p class="error"><?php echo h($output["error"]);?></p>
<?php endif; ?>
